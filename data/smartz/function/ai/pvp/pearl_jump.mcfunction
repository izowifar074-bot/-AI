# ============================================================
# smartz:ai/pvp/pearl_jump — 珍珠落点闪现（executor = 尸壳）
...
execute on target at @s facing entity @e[type=minecraft:husk,tag=sz.tpme,limit=1] feet positioned ^ ^ ^2.5 run tp @e[type=minecraft:husk,tag=sz.tpme,limit=1] ~ ~ ~

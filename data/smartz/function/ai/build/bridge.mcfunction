...
# 四方向放置：支撑位有洞 + 上两格可通行 → 放置并记录成功
execute align xyz if score #stepx sz.posx matches 1 if block ~1 ~-1 ~ #minecraft:replaceable if block ~1 ~ ~ #minecraft:replaceable if block ~1 ~1 ~ #minecraft:replaceable store success score #built sz.stuck run setblock ~1 ~-1 ~ minecraft:cobblestone
execute align xyz if score #stepx sz.posx matches -1 if block ~-1 ~-1 ~ #minecraft:replaceable if block ~-1 ~ ~ #minecraft:replaceable if block ~-1 ~1 ~ #minecraft:replaceable store success score #built sz.stuck run setblock ~-1 ~-1 ~ minecraft:cobblestone
execute align xyz if score #stepz sz.posz matches 1 if block ~ ~-1 ~1 #minecraft:replaceable if block ~ ~ ~1 #minecraft:replaceable if block ~ ~1 ~1 #minecraft:replaceable store success score #built sz.stuck run setblock ~ ~-1 ~1 minecraft:cobblestone
execute align xyz if score #stepz sz.posz matches -1 if block ~ ~-1 ~-1 #minecraft:replaceable if block ~ ~ ~-1 #minecraft:replaceable if block ~ ~1 ~-1 #minecraft:replaceable store success score #built sz.stuck run setblock ~ ~-1 ~-1 minecraft:cobblestone
# 成功后：音效 + 冷却
